<!-- resources/views/livewire/menus/admin-nav.blade.php -->
  ...
  <aside id="logo-sidebar"
    ...
    <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
      <ul class="space-y-2 font-medium">
        <li>
          <button wire:click="selectView('settings')"
        ...
        <li>
          <button wire:click="selectView('profile')"
                  class="flex items-center p-2 rounded hover:bg-gray-200 dark:hover:bg-gray-700">
          ...
          <x-dropdown align="right" width="48">
            ...
            <x-slot name="content">
              <div class="w-48">
                <ul class="space-y-2">
                  <li>
                    <button wire:click="selectView('users-list')"
                  ...
                  <li>
                    <button wire:click="selectView('users-permissions')"
                            class="flex items-center p-2 rounded hover:bg-gray-200 dark:hover:bg-gray-700 w-full text-left">
                  ...
                  <li>
                    <button wire:click="selectView('users-roles')"
                            class="flex items-center p-2 rounded hover:bg-gray-200 dark:hover:bg-gray-700 w-full text-left">
